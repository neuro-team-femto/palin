...
class InternalNoiseExtractor(ABC):
    ...
    @classmethod
    def extract_internal_noise(cls,data_df, group_ids, trial_id, feature_id, value_id, response_id, **kwargs):
        ...
        return data_df.groupby(group_ids).apply(lambda group: cls.extract_single_internal_noise(group, 
            trial_id, feature_id, value_id, response_id, **kwargs)).reset_index()
